...
ADD COLUMN IF NOT EXISTS company_percentage NUMERIC(5,2) DEFAULT 50 CHECK (company_percentage >= 0 AND company_percentage <= 100),
...
ADD COLUMN IF NOT EXISTS company_percentage NUMERIC(5,2) NOT NULL DEFAULT 50,
